...
diw = {69: 'i', 1: 'am', 2: 'going', 3: 'to', 4: 'the', 5: 'bar', 6: 'tonight', 7: 'love', 8: 'you', 9: 'miss',
       10: 'my', 11: 'dear', 12: 'lets', 13: 'go', 14: 'party', 15: 'and', 16: 'drinks', 17: 'congrats', 18: 'on',
       19: 'new', 20: 'job', 21: 'congratulations', 22: 'so', 23: 'happy', 24: 'for', 25: 'why', 26: 'are',
       27: 'feeling', 28: 'bad', 29: 'what', 30: 'is', 31: 'wrong', 32: 'with', 33: 'totally', 34: 'deserve',
       35: 'this', 36: 'prize', 37: 'let', 38: 'us', 39: 'play', 40: 'football', 41: 'down', 42: 'afternoon',
       43: 'work', 44: 'hard', 45: 'harder', 46: 'it', 47: 'suprising', 48: 'how', 49: 'people', 50: 'can', 51: 'be',
       52: 'dumb', 53: 'sometimes', 54: 'very', 55: 'disappointed', 56: 'best', 57: 'day', 58: 'in', 59: 'life',
       60: 'think', 61: 'will', 62: 'end', 63: 'up', 64: 'alone', 65: 'boring', 66: 'good', 67: 'great', 68: 'awesome'}
...
dwi = {'happy': 23, 'to': 3, 'harder': 45, 'feeling': 27, 'alone': 64, 'think': 60, 'bad': 28, 'i': 69, 'dear': 11,
       'it': 46, 'down': 41, 'be': 51, 'work': 43, 'great': 67, 'play': 39, 'this': 35, 'the': 4, 'love': 7, 'job': 20,
       'sometimes': 53, 'and': 15, 'day': 57, 'best': 56, 'bar': 5, 'disappointed': 55, 'on': 18, 'congratulations': 21,
       'let': 37, 'awesome': 68, 'can': 50, 'good': 66, 'new': 19, 'life': 59, 'us': 38, 'what': 29, 'up': 63,
       'going': 2, 'will': 61, 'miss': 9, 'totally': 33, 'with': 32, 'very': 54, 'so': 22, 'my': 10, 'tonight': 6,
       'are': 26, 'am': 1, 'suprising': 47, 'deserve': 34, 'lets': 12, 'football': 40, 'is': 30, 'go': 13, 'drinks': 16,
       'congrats': 17, 'you': 8, 'party': 14, 'people': 49, 'prize': 36, 'in': 58, 'hard': 44, 'why': 25, 'for': 24,
       'end': 62, 'afternoon': 42, 'how': 48, 'wrong': 31, 'dumb': 52, 'boring': 65}
...
d = {'i': np.asarray([1.18910000e-01, 1.52550000e-01, -8.20730000e-02,
     ...
     'am': np.asarray([0.34664, 0.39805, 0.4897, -0.51421, 0.54574, -1.2005,
                       ...
                       0.34037, 1.3588]), 'going': np.asarray([1.42120000e-02, -1.80110000e-01, 2.34780000e-01,
                                                               ...
                                                               6.15950000e-02, 6.99270000e-01]),
     'to': np.asarray([0.68047, -0.039263, 0.30186, -0.17792, 0.42962, 0.032246,
     ...
     'bar': np.asarray([-9.45310000e-01, 3.96860000e-01, -8.06050000e-01,
                        ...
                        9.53940000e-01, -6.35000000e-02]),
     'tonight': np.asarray([-0.24077, 0.64182, -0.24113, 0.75178, 0.53864,
                            ...
                            0.67139, 0.0269, -0.026077, -0.3064, 1.6869]),
     'love': np.asarray([-0.13886, 1.1401, -0.85212, -0.29212, 0.75534,
     ...
     'you': np.asarray([-1.09190000e-03, 3.33240000e-01, 3.57430000e-01,
     ...
     'miss': np.asarray([-3.22730000e-01, 5.61820000e-01, -6.63630000e-01,
                         ...
                         1.11300000e-01, 4.45000000e-01]),
     'my': np.asarray([-0.27279, 0.77515, -0.10181, -0.9166, 0.90477,
     ...
     'dear': np.asarray([-0.29946, 1.172, 0.3289, -0.74413, 1.0811, -0.1525,
                         ...
                         0.49816, 0.83257]), 'lets': np.asarray([0.30423, -0.24405, 1.0303, 0.039387, 0.23262, -0.39686,
                                                                 -0.36583, -0.18573, 0.31051, 0.48486, -0.035048,
                                                                 0.76138,
                                                                 ...
                                                                 -0.048207, -0.46385, -0.037947, -0.94777, 0.9061,
                                                                 0.28996,
                                                                 0.096715, 0.5577, -0.1583, -0.043148, 1.0421, -0.43296,
                                                                 -0.096168, 0.43463]),
     'go': np.asarray([1.48280000e-01, 1.77610000e-01, 4.23460000e-01,
                       ...
                       1.29710000e-01, 3.29530000e-01]),
     'party': np.asarray([-5.52700000e-01, -1.83340000e-01, 4.11460000e-01,
                          ...
                          1.01750000e+00, -5.99310000e-01]),
     'and': np.asarray([0.26818, 0.14346, -0.27877, 0.016257, 0.11384, 0.69923,
                        ...
                        -0.25028, -0.38097]),
     'drinks': np.asarray([0.18539, -0.30933, -0.91416, 0.17986, 0.43113, 0.26739,
                           ...
                           0.46365, 0.17851]), 'congrats': np.asarray([-5.70920000e-02, 5.04180000e-02, 2.48050000e-01,
                                                                       ...
                                                                       -4.58870000e-01, -1.32990000e-01,
                                                                       -2.58790000e-01,
                                                                       1.13250000e-02, -3.08230000e-01, 1.53970000e-01,
                                                                       4.33950000e-01, 7.08730000e-01, 2.95020000e-01,
                                                                       7.38500000e-01, 5.40940000e-01]),
     'on': np.asarray([0.30045, 0.25006, -0.16692, 0.1923, 0.026921,
     ...
     'new': np.asarray([1.95110000e-01, 5.07390000e-01, 1.47090000e-03,
                        ...
                        -1.42720000e-01, 4.54110000e-01]),
     'job': np.asarray([-0.20343, -0.045235, 0.23346, -0.59289, 0.49678,
                        ...
                        -0.54446, 0.055983, 0.78093, 0.0046384, 1.3011]),
     'congratulations': np.asarray([-0.098995, 1.3586, -0.16704, -0.32321, 0.61358, -1.2561,
                                    ...
                                    -0.32267, 0.10943]),
     'so': np.asarray([6.03080000e-01, -3.20240000e-01, 8.88570000e-02,
                       ...
                       -2.68790000e-01, 3.66570000e-01]),
     'happy': np.asarray([0.092086, 0.2571, -0.58693, -0.37029, 1.0828, -0.55466,
                          ...
                          0.10511, 0.87286]), 'for': np.asarray([0.15272, 0.36181, -0.22168, 0.066051, 0.13029, 0.37075,
                                                                 -0.75874, -0.44722, 0.22563, 0.10208, 0.054225,
                                                                 0.13494,
                                                                 -0.43052, -0.2134, 0.56139, -0.21445, 0.077974,
                                                                 0.10137,
                                                                 -0.51306, -0.40295, 0.40639, 0.23309, 0.20696,
                                                                 -0.12668,
                                                                 -0.50634, -1.7131, 0.077183, -0.39138, -0.10594,
                                                                 -0.23743,
                                                                 3.9552, 0.66596, -0.61841, -0.3268, 0.37021, 0.25764,
                                                                 0.38977, 0.27121, 0.043024, -0.34322, 0.020339, 0.2142,
                                                                 0.044097, 0.14003, -0.20079, 0.074794, -0.36076,
                                                                 0.43382,
                                                                 -0.084617, 0.1214]),
     'why': np.asarray([0.32386, 0.011154, 0.23443, -0.18039, 0.6233,
     ...
     'are': np.asarray([0.96193, 0.012516, 0.21733, -0.06539, 0.26843,
     ...
     'feeling': np.asarray([-0.07035, -0.12121, -0.52871, -0.62478, 0.75067, -0.05449,
                            ...
                            -0.21013, 0.47085]),
     'bad': np.asarray([-0.17981, -0.40407, -0.1653, -0.60687, -0.39656, 0.12688,
                        ...
                        0.99956, 0.72031]), 'what': np.asarray([0.45323, 0.059811, -0.10577, -0.333, 0.72359, -0.08717,
                                                                -0.61053, -0.037695, -0.30945, 0.21805, -0.43605,
                                                                0.47318,
                                                                -0.76866, -0.2713, 1.1042, 0.59141, 0.56962, -0.18678,
                                                                0.14867, -0.67292, -0.34672, 0.52284, 0.22959,
                                                                -0.072014,
                                                                ...
                                                                -0.011788, 0.48252, 0.024598, 0.34064, -0.084724,
                                                                0.5324,
                                                                -0.25103, 0.62546]),
     'is': np.asarray([6.18500000e-01, 6.42540000e-01, -4.65520000e-01,
                       ...
                       3.08990000e-01, 4.84970000e-01]),
     'wrong': np.asarray([0.13423, -0.70572, 0.25652, -0.70702, 0.66891,
                          ...
                          0.02628, -0.078312, 0.43723, 0.90636, 0.51193]),
     'with': np.asarray([0.25616, 0.43694, -0.11889, 0.20345, 0.41959, 0.85863,
                         ...
                         -0.25868, -0.39339]),
     'totally': np.asarray([0.40695, -1.4406, -0.17813, -0.21023, 0.36731, 0.26126,
                            ...
                            0.68669, 0.27528]),
     'deserve': np.asarray([-0.2927, 0.23329, -0.14797, -0.70162, 0.72223, -0.45522,
     ...
     'prize': np.asarray([-3.31750000e-01, 1.82220000e+00, 8.75410000e-02,
                          ...
                          -5.77180000e-01, -7.95250000e-01]),
     'let': np.asarray([0.067025, -0.010427, 0.61778, -0.29952, 0.68244,
                        ...
                        0.20926, 0.21338, -0.42741, -0.19243, 0.42443]),
     'us': np.asarray([0.19086, 0.24339, 1.2768, -0.038207, 0.6094,
                       ...
                       0.40002, -0.51528, 0.89973, -0.54324, 0.69393]),
     'play': np.asarray([-0.73571, 0.19937, -0.89408, 0.36406, -0.20246, -0.034324,
                         ...
                         -0.44448, 0.47437]),
     'football': np.asarray([-1.8209, 0.70094, -1.1403, 0.34363, -0.42266, -0.92479,
                             ...
                             -0.076259, -0.59909]),
     'down': np.asarray([-0.1981, -0.70847, 0.85857, -0.48108, 0.51562, -0.28924,
                         ...
                         0.30191, -0.89862]),
     'afternoon': np.asarray([0.13771, 0.15251, -0.28598, 0.34615, 0.074422, -1.4899,
                              ...
                              0.080406, 0.11109]), 'work': np.asarray([5.13590000e-01, 1.96950000e-01, -5.19440000e-01,
                                                                       ...
                                                                       -6.28970000e-01, 3.57260000e-01]),
     'hard': np.asarray([-0.53079, -0.21965, 0.53268, -0.23144, 0.074339, -0.065505,
                         ...
                         -0.24725, -0.030552]),
     'harder': np.asarray([-0.29399, -0.79617, 0.67096, -0.66914, -0.19887, 0.12998,
                           ...
                           -0.091229, 0.47121]),
     'it': np.asarray([0.61183, -0.22072, -0.10898, -0.052967, 0.50804, 0.34684,
                       ...
                       -0.097922, 0.16806]), 'suprising': np.asarray([0.14763, -0.66334, 0.22033, 0.16203, 0.90019,
                                                                      ...
                                                                      0.046639, -0.0059467, 1.0374, 0.16819, 0.25654]),
     'how': np.asarray([6.89380000e-01, -1.06440000e-01, 1.70830000e-01,
                        ...
                        -2.25040000e-01, 6.14120000e-01]),
     'people': np.asarray([0.95281, -0.20608, 0.55618, -0.46323, 0.73354,
                           ...
                           0.20884, -1.3281, -0.10882, -0.22822, -0.46303]),
     'can': np.asarray([0.8052, 0.37121, 0.55933, -0.011405, 0.17319, 0.195,
                        ...
                        -0.20902, 0.47612]), 'be': np.asarray([9.11020000e-01, -2.28720000e-01, 2.07700000e-01,
                                                               ...
                                                               -5.00630000e-02, 1.92410000e-01]),
     'dumb': np.asarray([-0.50578, -0.69265, -0.019215, -0.62411, 0.2218,
                         ...
                         0.3054, 0.063189, 0.16984, 0.9853, 1.026]),
     'sometimes': np.asarray([4.97020000e-01, 1.54370000e-02, -6.15460000e-01,
                              ...
                              -1.02060000e-01, 1.01460000e-01]),
     'very': np.asarray([5.70490000e-01, -7.78540000e-03, -7.07660000e-01,
                         ...
                         1.25730000e-01, 8.39390000e-01]),
     'disappointed': np.asarray([-2.26850000e-02, -8.59230000e-01, 4.94770000e-02,
                                 ...
                                 -7.83640000e-04, 6.03560000e-01]),
     'best': np.asarray([-9.15720000e-01, 6.03450000e-01, -3.10770000e-01,
                         ...
                         7.49880000e-02, 7.60920000e-01]),
     'day': np.asarray([0.11626, 0.53897, -0.39514, -0.26027, 0.57706, -0.79198,
     ...
     'life': np.asarray([0.51491, 0.88806, -0.71906, -0.5748, 0.85655, 0.52474,
                         ...
                         -0.066328, 0.13118]), 'think': np.asarray([-0.1166, -0.010887, 0.044444, -0.39349, 0.77743,
                                                                    ...
                                                                    0.26552, -0.23728, 0.44057, 0.0064518, 1.2454]),
     'will': np.asarray([8.15440000e-01, 3.01710000e-01, 5.47200000e-01,
                         ...
                         -3.47410000e-01, 4.16720000e-01]),
     'end': np.asarray([-0.04116, 0.22243, -0.11458, -0.33628, 0.038872, -0.066803,
                        ...
                        -0.37332, -0.18039]), 'up': np.asarray([0.032286, -0.27071, 0.68108, -0.27942, 0.5797,
                                                                ...
                                                                -0.09516, 0.25464, -0.56699, 0.033216, -0.58123]),
     'alone': np.asarray([0.5357, -0.10067, 0.53897, -0.36807, 0.67909, 0.31371,
                          ...
                          -0.22232, 0.16686]),
     'boring': np.asarray([-0.035674, -0.41765, -0.44104, -0.35455, -0.28748, -0.25642,
                           ...
                           0.37791, 0.98184]), 'good': np.asarray([-3.55860000e-01, 5.21300000e-01, -6.10700000e-01,
                                                                   ...
                                                                   3.13050000e-01, 9.27710000e-01]),
     'great': np.asarray([-0.026567, 1.3357, -1.028, -0.3729, 0.52012, -0.12699,
                          ...
                          -0.41618, -0.2549]),
     'awesome': np.asarray([-0.35848, -0.1155, 0.11371, 0.46814, 0.7495, -0.61523,
